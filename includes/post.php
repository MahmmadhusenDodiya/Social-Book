...
?>
      ...
      <?php echo '<div class="likeCnt" id="P'.$row['post_id'].'">'.'('.mysqli_num_rows($ress).')'.'</div>';?>  &nbsp;&nbsp; <?php echo "this is post id=".$row['post_id'];?>
        ...
        <script>
            $("#<?php echo 'L'.$row['post_id']; ?>").click(function(){
                console.log("cliked on this=<?php echo "L".$row['post_id']; ?> like button");
            });
            ...
            $('<?php echo '#L'.$row['post_id']; ?>').click(
                function()
                {
                    ...
                    console.log(document.querySelector('<?php echo '#L'.$row['post_id']; ?>').textContent);
