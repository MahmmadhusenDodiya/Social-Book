...
<!-- i have to do some changes in this also -->
<?php
...
<head>
    ...
    <!-- Font Awasam -->
    <!-- <script src="https://kit.fontawesome.com/0f9b251914.js" crossorigin="anonymous"></script> -->



    <!--Jquery Latest Verson 3.x not Compressed  -->
...
<body>
    <div class="container">
        ...
        <?php
        $postsql;
        if($isNotMyProfile == 0) { // Your Own Profile       
        ...
        if($postquery){
            ...
            if(mysqli_num_rows($postquery) == 0){ // No Posts
                if($isNotMyProfile == 0){ // Message shown if it's your own profile
                    echo '<div class="post">';
...
$("#bbtn").click(
    function()
    {
        console.log("Yes You <?php echo 'i am from php ';?>clicked on Req Button");
        
        console.log(document.querySelector('#bbtn').textContent);
        // document.querySelector('#bbtn').textContent="content changed";
        
        var a=document.querySelector('#bbtn').textContent;
        console.log(a);
        var u_id1=<?php echo  $current_id ?>;
        var u_id2=<?php echo $_SESSION['user_id'] ?>;
        $.ajax({
            url: "ajax-request.php",
            type: "POST",
            data:{curr_status:a , u1:u_id1 , u2:u_id2},
            success: function(data)
            {
                //console.log(data);
                document.querySelector('#bbtn').textContent=data;
               console.log("KK1");
            }
